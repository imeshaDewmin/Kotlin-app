...
import com.example.cafedavibeapp.databinding.ActivityProfileEditBinding
...
class ProfileEditActivity : AppCompatActivity() {
   ...
   //image uri (which we will pick)
    ...
    private fun uploadImage() {
        ...
        //image pas and name,use uid to replace previous
    ...
    private fun showImageAttachMenu(){
        /*Show popup menu options Camera, Gallery to pick image*/
